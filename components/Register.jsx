...
const Register = ({onClose,open }) => {
    ...
    return (
        <div className='fixed w-full h-full  z-1000 ' onClick={onClose}>
            <div className='fixed top-[20%] right-[37%] p-[50px] z-1000 bg-gray-300 rounded-md' >
                ...
                <input type="text" placeholder='Nickname' className='w-96 rounded outline-none p-1 mb-5' />
